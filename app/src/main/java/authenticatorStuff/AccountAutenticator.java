...
import static authenticatorStuff.AccountGeneral.*;
...
public class AccountAutenticator extends AbstractAccountAuthenticator {
    ...
    private String TAG = "BrainstormingAuthenticator";
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                try {
                    answer = sServerAuthenticate.userSignIn(account.name, password, authTokenType);
